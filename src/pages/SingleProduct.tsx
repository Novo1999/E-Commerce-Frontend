...
const SingleProduct = () => {
  ...
  return isLoading ? (
    ...
    <section className='py-6 h-full gap-2 px-2 font-poppins'>
      <div className='border-2 border-slate-400 rounded-lg mx-4 p-4 sm:py-10 sm:px-0 bg-slate-200 flex flex-col sm:flex-row justify-between lg:h-[32rem] items-center'>
        {/* LEFT DIV */}
        <div className='place-items-start flex flex-col lg:items-center sm:ml-10 lg:gap-10'>
          <div className='min-w-60'>
            <img
              className='w-fit h-fit sm:w-60 sm:h-52 lg:h-fit object-contain'
              src={link}
              alt='product image'
            />
          </div>
          <div className='m-auto w-full'>
            ...
            <div className='flex m-auto items-center my-4'>
        ...
        {/* RIGHT DIV */}
        <div className='space-y-6 sm:flex flex-col items-center sm:items-start lg:mb-[75px]'>
          <p className='text-center font-semibold text-3xl'>Price: ${price}</p>
          <p className='text-sm lg:text-lg text-center mb-40 sm:mx-2'>
            {description}
          </p>
          ...
          >
            <div className='badge badge-accent text-xs lg:text-lg lg:p-4'>
              {category}
            </div>
          </Link>
